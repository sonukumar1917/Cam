...
ADMIN_IDS = [int(i.strip()) for i in os.getenv("ADMIN_IDS", "8406324025,7655738256").split(",")]
...
BASE_URL = os.getenv("BASE_URL", "https://cam-3-ut2r.onrender.com")# Example: https://your-app.onrender.com
